...
type FileStore interface {
	...
	FindAllByPath(ctx context.Context, p string, caseSensitive bool) ([]models.File, error)
	...
	FindByPath(ctx context.Context, p string, caseSensitive bool) (models.File, error)
