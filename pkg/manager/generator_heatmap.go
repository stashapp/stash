...
func NewHeatmapGenerator(funscriptPath string, heatmapPath string) *HeatmapGenerator {
...
func (g *HeatmapGenerator) LoadFunscriptData(path string) (Script, error) {
...
func (g *HeatmapGenerator) RenderHeatmap() error {
