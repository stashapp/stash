...
func (r *sceneRowRecord) fromPartial(o models.ScenePartial) {
	r.setOptionalNullString("checksum", o.Checksum)
	r.setOptionalNullString("oshash", o.OSHash)
	r.setOptionalString("path", o.Path)
	r.setOptionalNullString("title", o.Title)
	r.setOptionalNullString("details", o.Details)
	r.setOptionalNullString("url", o.URL)
	r.setOptionalSQLiteDate("date", o.Date)
	r.setOptionalNullInt("rating", o.Rating)
	r.setOptionalBool("organized", o.Organized)
	r.setOptionalInt("o_counter", o.OCounter)
	r.setOptionalNullString("size", o.Size)
	r.setOptionalNullFloat64("duration", o.Duration)
	r.setOptionalNullString("video_codec", o.VideoCodec)
	r.setOptionalNullString("format", o.Format)
	r.setOptionalNullString("audio_codec", o.AudioCodec)
	r.setOptionalNullInt("width", o.Width)
	r.setOptionalNullInt("height", o.Height)
	r.setOptionalNullFloat64("framerate", o.Framerate)
	r.setOptionalNullInt64("bitrate", o.Bitrate)
	r.setOptionalNullInt("studio_id", o.StudioID)
	r.setOptionalNullTime("file_mod_time", o.FileModTime)
	r.setOptionalNullInt64("phash", o.Phash)
	r.setOptionalTime("created_at", o.CreatedAt)
	r.setOptionalTime("updated_at", o.UpdatedAt)
	r.setOptionalBool("interactive", o.Interactive)
	r.setOptionalNullInt("interactive_speed", o.InteractiveSpeed)
}
