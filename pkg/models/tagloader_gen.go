...
func (l *TagLoader) Load(key int) (*Tag, error) {
...
func (l *TagLoader) LoadThunk(key int) func() (*Tag, error) {
	l.mu.Lock()
...
func (l *TagLoader) LoadAll(keys []int) ([]*Tag, []error) {
	results := make([]func() (*Tag, error), len(keys))
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *TagLoader) LoadAllThunk(keys []int) func() ([]*Tag, []error) {
	results := make([]func() (*Tag, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *TagLoader) Prime(key int, value *Tag) bool {
	l.mu.Lock()
	var found bool
...
func (l *TagLoader) unsafeSet(key int, value *Tag) {
	if l.cache == nil {
		l.cache = map[int]*Tag{}
	}
	l.cache[key] = value
