...
type mockConstructorTestingTNewGalleryChapterReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGalleryChapterReaderWriter(t mockConstructorTestingTNewGalleryChapterReaderWriter) *GalleryChapterReaderWriter {
