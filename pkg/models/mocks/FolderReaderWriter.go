...
func (_m *FolderReaderWriter) Find(ctx context.Context, id models.FolderID) (*models.Folder, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.FolderID) (*models.Folder, error)); ok {
		return rf(ctx, id)
	}
...
func (_m *FolderReaderWriter) FindAllInPaths(ctx context.Context, p []string, includeZipContents bool, limit int, offset int) ([]*models.Folder, error) {
	...
	var r0 []*models.Folder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, bool, int, int) ([]*models.Folder, error)); ok {
		return rf(ctx, p, includeZipContents, limit, offset)
	}
...
func (_m *FolderReaderWriter) FindByPath(ctx context.Context, path string, caseSensitive bool) (*models.Folder, error) {
	...
	var r0 *models.Folder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*models.Folder, error)); ok {
		return rf(ctx, path, caseSensitive)
	}
...
func (_m *FolderReaderWriter) FindByZipFileID(ctx context.Context, zipFileID models.FileID) ([]*models.Folder, error) {
	...
	var r0 []*models.Folder
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.FileID) ([]*models.Folder, error)); ok {
...
func (_m *FolderReaderWriter) GetManyParentFolderIDs(ctx context.Context, folderIDs []models.FolderID) ([][]models.FolderID, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []models.FolderID) ([][]models.FolderID, error)); ok {
		return rf(ctx, folderIDs)
	}
...
func (_m *FolderReaderWriter) Query(ctx context.Context, options models.FolderQueryOptions) (*models.FolderQueryResult, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.FolderQueryOptions) (*models.FolderQueryResult, error)); ok {
...
type mockConstructorTestingTNewFolderReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}

// NewFolderReaderWriter creates a new instance of FolderReaderWriter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewFolderReaderWriter(t mockConstructorTestingTNewFolderReaderWriter) *FolderReaderWriter {
	mock := &FolderReaderWriter{}
	mock.Mock.Test(t)
