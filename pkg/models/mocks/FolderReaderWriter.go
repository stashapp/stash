...
func (_m *FolderReaderWriter) CountMissingInPaths(ctx context.Context, p []string, missingSinceBefore *time.Time) (int, error) {
...
func (_m *FolderReaderWriter) FindMissingInPaths(ctx context.Context, p []string, missingSinceBefore *time.Time, limit int, offset int) ([]*models.Folder, error) {
	ret := _m.Called(ctx, p, missingSinceBefore, limit, offset)

	var r0 []*models.Folder
	if rf, ok := ret.Get(0).(func(context.Context, []string, *time.Time, int, int) []*models.Folder); ok {
...
func (_m *FolderReaderWriter) SetMissing(ctx context.Context, id models.FolderID, missingSince *time.Time) error {
	ret := _m.Called(ctx, id, missingSince)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.FolderID, *time.Time) error); ok {
