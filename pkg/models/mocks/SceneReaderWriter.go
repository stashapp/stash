...
// DecrementOCounterDate provides a mock function with given fields: ctx, id
func (_m *SceneReaderWriter) DecrementOCounterDate(ctx context.Context, id int) (int, error) {
...
// IncrementOCounterDate provides a mock function with given fields: ctx, id
func (_m *SceneReaderWriter) IncrementOCounterDate(ctx context.Context, id int) (int, error) {
	ret := _m.Called(ctx, id)
...
// ResetOCounterDate provides a mock function with given fields: ctx, id
func (_m *SceneReaderWriter) ResetOCounterDate(ctx context.Context, id int) (int, error) {
	ret := _m.Called(ctx, id)
