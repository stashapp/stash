...
type mockConstructorTestingTNewPerformerReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPerformerReaderWriter(t mockConstructorTestingTNewPerformerReaderWriter) *PerformerReaderWriter {
