...
// CountMissingInPaths provides a mock function with given fields: ctx, p, missingSinceBefore
func (_m *FileReaderWriter) CountMissingInPaths(ctx context.Context, p []string, missingSinceBefore *time.Time) (int, error) {
	ret := _m.Called(ctx, p, missingSinceBefore)

	var r0 int
	if rf, ok := ret.Get(0).(func(context.Context, []string, *time.Time) int); ok {
		r0 = rf(ctx, p, missingSinceBefore)
	} else {
		r0 = ret.Get(0).(int)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context, []string, *time.Time) error); ok {
		r1 = rf(ctx, p, missingSinceBefore)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *FileReaderWriter) FindByFolderID(ctx context.Context, folderID models.FolderID) ([]models.File, error) {
	ret := _m.Called(ctx, folderID)

	var r0 []models.File
	if rf, ok := ret.Get(0).(func(context.Context, models.FolderID) []models.File); ok {
		r0 = rf(ctx, folderID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.File)
...
// FindMissingInPaths provides a mock function with given fields: ctx, p, missingSinceBefore, limit, offset
func (_m *FileReaderWriter) FindMissingInPaths(ctx context.Context, p []string, missingSinceBefore *time.Time, limit int, offset int) ([]models.File, error) {
	ret := _m.Called(ctx, p, missingSinceBefore, limit, offset)

	var r0 []models.File
	if rf, ok := ret.Get(0).(func(context.Context, []string, *time.Time, int, int) []models.File); ok {
		r0 = rf(ctx, p, missingSinceBefore, limit, offset)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.File)
		}
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []string, *time.Time, int, int) error); ok {
		r1 = rf(ctx, p, missingSinceBefore, limit, offset)
	} else {
		r1 = ret.Error(1)
	}
...
// SetMissing provides a mock function with given fields: ctx, id, missingSince
func (_m *FileReaderWriter) SetMissing(ctx context.Context, id models.FileID, missingSince *time.Time) error {
	ret := _m.Called(ctx, id, missingSince)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, models.FileID, *time.Time) error); ok {
		r0 = rf(ctx, id, missingSince)
	} else {
		r0 = ret.Error(0)
	}
