...
func (_m *FileReaderWriter) FindAllByPath(ctx context.Context, path string, caseSensitive bool) ([]models.File, error) {
	...
	var r0 []models.File
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) ([]models.File, error)); ok {
...
func (_m *FileReaderWriter) FindAllInPaths(ctx context.Context, p []string, includeZipContents bool, limit int, offset int) ([]models.File, error) {
	...
	var r0 []models.File
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, bool, int, int) ([]models.File, error)); ok {
...
type mockConstructorTestingTNewFileReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFileReaderWriter(t mockConstructorTestingTNewFileReaderWriter) *FileReaderWriter {
