...
type mockConstructorTestingTNewSavedFilterReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSavedFilterReaderWriter(t mockConstructorTestingTNewSavedFilterReaderWriter) *SavedFilterReaderWriter {
