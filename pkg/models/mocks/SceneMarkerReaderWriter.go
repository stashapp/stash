...
type mockConstructorTestingTNewSceneMarkerReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSceneMarkerReaderWriter(t mockConstructorTestingTNewSceneMarkerReaderWriter) *SceneMarkerReaderWriter {
