...
type mockConstructorTestingTNewStudioReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewStudioReaderWriter(t mockConstructorTestingTNewStudioReaderWriter) *StudioReaderWriter {
