...
func (_m *StudioReaderWriter) Find(ctx context.Context, id int) (*models.Studio, error) {
	...
	var r0 *models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, int) (*models.Studio, error)); ok {
		return rf(ctx, id)
	}
...
func (_m *StudioReaderWriter) FindByName(ctx context.Context, name string, nocase bool) (*models.Studio, error) {
	...
	var r0 *models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*models.Studio, error)); ok {
...
func (_m *StudioReaderWriter) FindByStashID(ctx context.Context, stashID models.StashID) ([]*models.Studio, error) {
	...
	var r0 []*models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.StashID) ([]*models.Studio, error)); ok {
...
func (_m *StudioReaderWriter) FindByStashIDStatus(ctx context.Context, hasStashID bool, stashboxEndpoint string) ([]*models.Studio, error) {
	...
	var r0 []*models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool, string) ([]*models.Studio, error)); ok {
...
func (_m *StudioReaderWriter) Query(ctx context.Context, studioFilter *models.StudioFilterType, findFilter *models.FindFilterType) ([]*models.Studio, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.StudioFilterType, *models.FindFilterType) ([]*models.Studio, int, error)); ok {
		return rf(ctx, studioFilter, findFilter)
	}
...
func (_m *StudioReaderWriter) QueryCount(ctx context.Context, studioFilter *models.StudioFilterType, findFilter *models.FindFilterType) (int, error) {
	...
	var r0 int
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *models.StudioFilterType, *models.FindFilterType) (int, error)); ok {
		return rf(ctx, studioFilter, findFilter)
	}
...
func (_m *StudioReaderWriter) QueryForAutoTag(ctx context.Context, words []string) ([]*models.Studio, error) {
	...
	var r0 []*models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) ([]*models.Studio, error)); ok {
		return rf(ctx, words)
	}
...
func (_m *StudioReaderWriter) UpdatePartial(ctx context.Context, updatedStudio models.StudioPartial) (*models.Studio, error) {
	...
	var r0 *models.Studio
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.StudioPartial) (*models.Studio, error)); ok {
		return rf(ctx, updatedStudio)
	}
...
// NewStudioReaderWriter creates a new instance of StudioReaderWriter. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewStudioReaderWriter(t interface {
	mock.TestingT
	Cleanup(func())
}) *StudioReaderWriter {
	mock := &StudioReaderWriter{}
	mock.Mock.Test(t)
