...
func (_m *TagReaderWriter) FindByStashID(ctx context.Context, stashID models.StashID) ([]*models.Tag, error) {
	...
	var r0 []*models.Tag
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, models.StashID) ([]*models.Tag, error)); ok {
...
func (_m *TagReaderWriter) FindByStashIDStatus(ctx context.Context, hasStashID bool, stashboxEndpoint string) ([]*models.Tag, error) {
	...
	var r0 []*models.Tag
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, bool, string) ([]*models.Tag, error)); ok {
...
type mockConstructorTestingTNewTagReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewTagReaderWriter(t mockConstructorTestingTNewTagReaderWriter) *TagReaderWriter {
