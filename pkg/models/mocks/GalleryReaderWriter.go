...
type mockConstructorTestingTNewGalleryReaderWriter interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewGalleryReaderWriter(t mockConstructorTestingTNewGalleryReaderWriter) *GalleryReaderWriter {
