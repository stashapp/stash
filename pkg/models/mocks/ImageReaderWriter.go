...
func (_m *ImageReaderWriter) Query(imageFilter *models.ImageFilterType, findFilter *models.FindFilterType) ([]*models.Image, int, float64, int, error) {
	...
	var r2 float64
	if rf, ok := ret.Get(2).(func(*models.ImageFilterType, *models.FindFilterType) float64); ok {
	...
	var r3 int
	if rf, ok := ret.Get(3).(func(*models.ImageFilterType, *models.FindFilterType) int); ok {
		r3 = rf(imageFilter, findFilter)
	} else {
		r3 = ret.Get(3).(int)
	}

	var r4 error
	if rf, ok := ret.Get(4).(func(*models.ImageFilterType, *models.FindFilterType) error); ok {
		r4 = rf(imageFilter, findFilter)
	} else {
		r4 = ret.Error(4)
	}
