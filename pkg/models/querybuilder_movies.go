...
func (qb *MovieQueryBuilder) Create(newMovie Movie, tx *sqlx.Tx) (*Movie, error) {
	...
	result, err := tx.NamedExec(
		`INSERT INTO movies (front_image, back_image, checksum, name, aliases, duration_movie, date_movie, rating_movie, director, synopsis, url, created_at, updated_at)
				VALUES (:front_image, :back_image, :checksum, :name, :aliases, :duration_movie, :date_movie, :rating_movie, :director, :synopsis, :url, :created_at, :updated_at)
		`,
		newMovie,
	)
	if err != nil {
