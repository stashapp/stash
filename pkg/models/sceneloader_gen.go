...
func (l *SceneLoader) Load(key int) (*Scene, error) {
...
func (l *SceneLoader) LoadThunk(key int) func() (*Scene, error) {
	l.mu.Lock()
...
func (l *SceneLoader) LoadAll(keys []int) ([]*Scene, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *SceneLoader) LoadAllThunk(keys []int) func() ([]*Scene, []error) {
	results := make([]func() (*Scene, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *SceneLoader) Prime(key int, value *Scene) bool {
	l.mu.Lock()
	var found bool
...
func (l *SceneLoader) unsafeSet(key int, value *Scene) {
	if l.cache == nil {
		l.cache = map[int]*Scene{}
	}
	l.cache[key] = value
}
