...
const (
	ProjectionEnumAuto    ProjectionEnum = "AUTO"
	ProjectionEnumFlat    ProjectionEnum = "FLAT"
	ProjectionEnumDome    ProjectionEnum = "DOME"
	ProjectionEnumSphere  ProjectionEnum = "SPHERE"
	...
	ProjectionEnumCube    ProjectionEnum = "CUBE"
	ProjectionEnumEac     ProjectionEnum = "EAC"
)
...
func (e ProjectionEnum) IsValid() bool {
	switch e {
	case ProjectionEnumAuto, ProjectionEnumFlat, ProjectionEnumDome, ProjectionEnumSphere, ProjectionEnumFisheye, ProjectionEnumMkx200, ProjectionEnumRf52, ProjectionEnumCube, ProjectionEnumEac:
		return true
	}
	return false
}
...
const (
	StereoModeEnumAuto      StereoModeEnum = "AUTO"
	StereoModeEnumMono      StereoModeEnum = "MONO"
	StereoModeEnumTopBottom StereoModeEnum = "TOP_BOTTOM"
	StereoModeEnumLeftRight StereoModeEnum = "LEFT_RIGHT"
)

var AllStereoModeEnum = []StereoModeEnum{
	StereoModeEnumAuto,
	StereoModeEnumMono,
	StereoModeEnumTopBottom,
	StereoModeEnumLeftRight,
}

func (e StereoModeEnum) IsValid() bool {
	switch e {
	case StereoModeEnumAuto, StereoModeEnumMono, StereoModeEnumTopBottom, StereoModeEnumLeftRight:
		return true
	}
	return false
}
