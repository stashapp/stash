...
The container runs Stash as a non-root user by default. Set `PUID` and `PGID` in `docker-compose.yml` to the owner of the host directories you mount into the container.
