...
export type ConfigInterfaceDataFragment = (
  { __typename?: 'ConfigInterfaceResult' }
  & Pick<ConfigInterfaceResult, 'soundOnPreview' | 'wallShowTitle' | 'maximumLoopDuration' | 'autostartVideo' | 'showStudioAsText' | 'css' | 'cssEnabled'>
);
...
export type ScrapedPerformerDataFragment = (
  { __typename?: 'ScrapedPerformer' }
  & Pick<ScrapedPerformer, 'name' | 'url' | 'birthdate' | 'ethnicity' | 'country' | 'eye_color' | 'height' | 'measurements' | 'fake_tits' | 'career_length' | 'tattoos' | 'piercings' | 'aliases'>
);
