#### 💥 **Note: After upgrading, please [verify your stash library settings](/settings?tab=configuration) and perform a [scan](/tasks) to populate gallery images and the file modification times in the database. **
