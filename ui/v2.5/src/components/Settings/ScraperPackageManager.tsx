...
import { PatchContainerComponent, PatchComponent } from "src/patch";

// Apply PatchComponent to InstalledScraperPackages
export const InstalledScraperPackages: React.FC = PatchComponent(
...
// Apply PatchComponent to AvailableScraperPackages
export const AvailableScraperPackages: React.FC = PatchComponent(
