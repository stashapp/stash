...
export const StashBoxModal: React.FC<IStashBoxModal> = PatchComponent(
  "StashBoxModal",
  ({ value, close }: IStashBoxModal) => {
    const intl = useIntl();
...
export const StashBoxSetting: React.FC<IStashBoxSetting> = PatchComponent(
  "StashBoxSetting",
  ({ value, onChange }: IStashBoxSetting) => {
