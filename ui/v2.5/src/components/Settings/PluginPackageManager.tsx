...
// Apply PatchComponent to InstalledPluginPackages
export const InstalledPluginPackages: React.FC = PatchComponent(
...
// Apply PatchComponent to AvailablePluginPackages
export const AvailablePluginPackages: React.FC = PatchComponent(
