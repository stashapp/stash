...
const CleanDialog: React.FC<ICleanDialog> = PatchComponent(
  "CleanDialog",
  ({ pathSelection = false, dryRun, onClose }: ICleanDialog) => {
    const intl = useIntl();
...
const CleanOptions: React.FC<ICleanOptions> = PatchComponent(
  "CleanOptions",
  ({ options, setOptions: setOptionsState }: ICleanOptions) => {
...
export const DataManagementTasks: React.FC<IDataManagementTasks> =
  PatchComponent(
    "DataManagementTasks",
    ({ setIsBackupRunning, setIsAnonymiseRunning }: IDataManagementTasks) => {
      const intl = useIntl();
      ...
      function renderImportDialog() {
        ...
        return (
          <ImportDialog onClose={() => setDialogOpen({ import: false })} />
        );
      }
          ...
          <SettingSection headingID="config.tasks.migrations">
            ...
            <div className="setting-group">
              ...
              <BooleanSetting
                ...
                checked={
                  migrateSceneScreenshotsOptions.overwriteExisting ?? false
                }
