...
const CleanDialog: React.FC<ICleanDialog> = PatchComponent(
  "CleanDialog",
  ({ pathSelection = false, dryRun, onClose }) => {
    const intl = useIntl();
...
export const DataManagementTasks: React.FC<IDataManagementTasks> = PatchComponent(
  "DataManagementTasks",
  ({ setIsBackupRunning, setIsAnonymiseRunning }) => {
    const intl = useIntl();
