...
export const SettingsServicesPanel: React.FC = PatchComponent(
  ...
  () => {
    ...
    const [enableUntilRestart, setEnableUntilRestart] =
    ...
    function renderAllowedIPs() {
      if (
        !statusData ||
        statusData.dlnaStatus.allowedIPAddresses.length === 0
      ) {
        return;
      }
