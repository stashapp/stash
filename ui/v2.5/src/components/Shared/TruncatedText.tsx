...
const TruncatedText: React.FC<ITruncatedTextProps> = ({ text, className, lineCount = 1, placement = "bottom", delay = 1000 }) => {
  ...
  const handleFocus = (element: HTMLElement) => {
    ...
    if ((element.offsetWidth < element.scrollWidth) || ((element.offsetHeight + 10) < element.scrollHeight))
      startShowingTooltip();
  };
