...
// audio has no director field
const audioFields = ["code", "rating100", "details", "organized", "date"];
...
export const EditAudiosDialog: React.FC<IListOperationProps> = (
  ...
  const aggregateState = useMemo(() => {
    ...
    state.forEach((audio: GQL.SlimAudioDataFragment) => {
  ...
  function getAudioInput(): GQL.BulkAudioUpdateInput {
    const audioInput: GQL.BulkAudioUpdateInput = {
      ...updateInput,
      tag_ids: tagIds,
    ...
    audioInput.rating100 = getAggregateInputValue(
  ...
  return (
    ...
    >
      <Form>
        ...
        <BulkUpdateFormGroup name="audio_code">
          <BulkUpdateTextInput
