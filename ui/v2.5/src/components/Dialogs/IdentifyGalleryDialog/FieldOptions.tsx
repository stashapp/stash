...
import {
  multiValueGalleryFields,
  GalleryField,
  galleryFieldMessageID,
  galleryFields,
} from "./constants";
...
const FieldOptionsEditor: React.FC<IFieldOptionsEditor> = ({
  ...
  function renderField() {
    return intl.formatMessage({ id: galleryFieldMessageID(field) });
  }
  ...
  function maybeRenderCreateMissing() {
    ...
    if (
      multiValueGalleryFields.includes(localOptions.field as GalleryField) &&
