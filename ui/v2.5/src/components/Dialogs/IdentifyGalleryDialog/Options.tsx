...
import { ThreeStateBoolean } from "../IdentifyDialog/ThreeStateBoolean";
import { TagSelect } from "src/components/Shared/Select";

interface IOptionsEditor {
  options: GQL.IdentifyGalleryMetadataOptionsInput;
  setOptions: (s: GQL.IdentifyGalleryMetadataOptionsInput) => void;
  source?: IScraperSource;
  defaultOptions?: GQL.IdentifyGalleryMetadataOptionsInput;
...
export const OptionsEditor: React.FC<IOptionsEditor> = ({
  ...
  function setOptions(v: Partial<GQL.IdentifyGalleryMetadataOptionsInput>) {
