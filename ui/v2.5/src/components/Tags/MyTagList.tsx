...
const SidebarContent: React.FC<{
  ...
  const PerformerCountCriterionOption =
    createMandatoryNumberCriterionOption("performer_count");
  const StudioCountCriterionOption =
    createMandatoryNumberCriterionOption("studio_count");
  const GroupCountCriterionOption =
    createMandatoryNumberCriterionOption("group_count");
  const MarkerCountCriterionOption =
      ...
      <MyTagsFilterSidebarSections>
        <div className="sidebar-filters">
          ...
          <SidebarStringFilter
            ...
            data-type={DescriptionCriterionOption.type}
          ...
          <SidebarNumberFilter
            ...
            data-type={PerformerCountCriterionOption.type}
          ...
          <SidebarNumberFilter
            ...
            data-type={StudioCountCriterionOption.type}
          ...
          <SidebarNumberFilter
            ...
            data-type={GroupCountCriterionOption.type}
          ...
          <SidebarNumberFilter
            ...
            data-type={MarkerCountCriterionOption.type}
          ...
          <SidebarBooleanFilter
            ...
            data-type={FavoriteTagCriterionOption.type}
