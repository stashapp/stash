 ...
 *
 * Displays filter criteria as visual tags with icons, modifiers, and depth indicators.
 *
 * Features:
 * - Icons for each criterion type (tags, performers, studios, etc.)
 * - Modifier indicators (includes, excludes, equals, etc.)
 * - Depth indicators for hierarchical filters
 * - Overflow handling with "more" popover
