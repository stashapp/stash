/**
 * Enhanced Queue Viewer
 *
 * A complete rewrite of the upstream QueueViewer with:
 * - Discover filter tabs (Queue, Similar, Studio, Performers)
 * - Scene recommendations based on current scene
 * - Thumbnail previews with scene specs
