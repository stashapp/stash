/**
 * Scene.tsx - Extension Version
 *
 * This is our fork's customized Scene page component with:
 * - Auto-collapsing tabs for responsive overflow
 * - Studio background image support
 * - Dual header rendering (primary + secondary)
 * - "Discover" tab (renamed from Queue)
 * - Consolidated Groups/Galleries into SceneDetailPanel
 * - discoverQueue state management
 *
 * The upstream version has been reverted to v0.29.3.
 * This file is used via re-export from the original location.
 */
...
import { SceneEditPanel } from "src/components/Scenes/SceneDetails/SceneEditPanel";
...
const ExternalPlayerButton = lazyComponent(
  () => import("src/components/Scenes/SceneDetails/ExternalPlayerButton")
);
...
const DeleteScenesDialog = lazyComponent(() => import("src/components/Scenes/DeleteScenesDialog"));
