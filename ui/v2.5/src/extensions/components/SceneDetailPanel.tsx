/**
 * Enhanced Scene Detail Panel
 *
 * An enhanced version of the upstream SceneDetailPanel with:
 * - Collapsible sections (details, galleries, performers, tags)
 * - Inline gallery viewer
 * - Performer cards with age calculation
 * - Group cards with scene numbers
