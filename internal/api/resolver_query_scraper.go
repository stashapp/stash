...
func (r *queryResolver) QueryStashBoxScene(ctx context.Context, input StashBoxSceneQueryInput) ([]*scraper.ScrapedScene, error) {
...
func (r *queryResolver) QueryStashBoxPerformer(ctx context.Context, input StashBoxPerformerQueryInput) ([]*stashbox.StashBoxPerformerQueryResult, error) {
	boxes := config.GetInstance().GetStashBoxes()
...
func (r *queryResolver) ScrapeSingleScene(ctx context.Context, source models.ScraperSourceInput, input ScrapeSingleSceneInput) ([]*scraper.ScrapedScene, error) {
...
func (r *queryResolver) ScrapeMultiScenes(ctx context.Context, source models.ScraperSourceInput, input ScrapeMultiScenesInput) ([][]*scraper.ScrapedScene, error) {
...
func (r *queryResolver) ScrapeSinglePerformer(ctx context.Context, source models.ScraperSourceInput, input ScrapeSinglePerformerInput) ([]*models.ScrapedPerformer, error) {
	if source.ScraperID != nil {
...
func (r *queryResolver) ScrapeMultiPerformers(ctx context.Context, source models.ScraperSourceInput, input ScrapeMultiPerformersInput) ([][]*models.ScrapedPerformer, error) {
	if source.ScraperID != nil {
		return nil, ErrNotImplemented
	} else if source.StashBoxIndex != nil {
		client, err := r.getStashBoxClient(*source.StashBoxIndex)
...
func (r *queryResolver) ScrapeSingleGallery(ctx context.Context, source models.ScraperSourceInput, input ScrapeSingleGalleryInput) ([]*scraper.ScrapedGallery, error) {
...
func (r *queryResolver) ScrapeSingleMovie(ctx context.Context, source models.ScraperSourceInput, input ScrapeSingleMovieInput) ([]*models.ScrapedMovie, error) {
	return nil, ErrNotSupported
}
