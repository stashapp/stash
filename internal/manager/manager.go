...
func (s *singleton) Setup(ctx context.Context, input SetupInput) error {
...
func (s *singleton) Migrate(ctx context.Context, input MigrateInput) error {
...
func (s *singleton) GetSystemStatus() *SystemStatus {
